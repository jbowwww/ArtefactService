			...
			get
			{
				if (_configuration == null)
				{
					_configuration = Fluently.Configure().Database(
						MySQLConfiguration.Standard.ConnectionString("Database=Artefacts4;Data Source=localhost;User Id=root"))
						.Mappings(m => m.AutoMappings
//							.Add(AutoMap.AssemblyOf<Artefact>(_mapping))
							.Add(AutoMap.AssemblyOf<Artefacts.Host>(_mapping))
							.Add(AutoMap.Assemblies(_mapping, Artefact.ArtefactTypes.ConvertAll<Assembly>(T => T.Assembly).Distinct())))
